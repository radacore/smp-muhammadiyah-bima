...
<div class="form-group row">
	...
	<div class="col-md-9">
		...
		<small class="text-secondary">Pilih gambar utama untuk fasilitas.</small>
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-md-2">
		<select name="kondisi_fasilitas" class="form-control">
			<option value="Baik" <?php echo set_select('kondisi_fasilitas', 'Baik', true); ?>>Baik</option>
			<option value="Rusak" <?php echo set_select('kondisi_fasilitas', 'Rusak'); ?>>Rusak</option>
			<option value="Hilang" <?php echo set_select('kondisi_fasilitas', 'Hilang'); ?>>Hilang</option>
		</select>
...
<div class="form-group row">
	...
	<div class="col-md-4">
		<select name="id_kategori_fasilitas" class="form-control select2">
			...
			<option value="<?php echo $kategori_fasilitas->id_kategori_fasilitas ?>" <?php echo set_select('id_kategori_fasilitas', $kategori_fasilitas->id_kategori_fasilitas); ?>>
	...
	<div class="col-md-2">
		<select name="status_fasilitas" class="form-control">
			<option value="Publish" <?php echo set_select('status_fasilitas', 'Publish', true); ?>>Publish</option>
			<option value="Draft" <?php echo set_select('status_fasilitas', 'Draft'); ?>>Draft</option>
		</select>
...
<div class="form-group row">
	...
	<div class="col-md-9">
		...
		<textarea name="isi" class="form-control konten" placeholder="Deskripsi dan detail fasilitas"><?php echo set_value('isi') ?></textarea>
	</div>
</div>
