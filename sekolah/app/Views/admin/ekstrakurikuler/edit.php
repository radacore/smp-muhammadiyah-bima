...
<div class="form-group row">
	...
	<div class="col-md-1">
		<img src="<?php echo base_url('assets/upload/image/thumbs/'.$ekstrakurikuler->gambar) ?>" class="img img-thumbnail" alt="Gambar Ekstrakurikuler">
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-md-2">
		<select name="status_ekstrakurikuler" class="form-control">
			<option value="Publish" <?php if($ekstrakurikuler->status_ekstrakurikuler=="Publish") { echo 'selected'; } ?>>Publish</option>
	...
	<div class="col-md-2">
		<select name="status_text" class="form-control">
			<option value="Ya" <?php if($ekstrakurikuler->status_text=="Ya") { echo 'selected'; } ?>>Aktif</option>
...
<div class="form-group row">
	...
	<div class="col-md-10">
		...
		<textarea name="isi" class="form-control konten" placeholder="Deskripsi dan detail ekstrakurikuler"><?php echo $ekstrakurikuler->isi ?></textarea>
	</div>
</div>
