...
<div class="form-group row">
	...
	<div class="col-md-9">
		<input type="text" name="judul_download" class="form-control" value="<?php echo set_value('judul_download', $download->judul_download) ?>" required>
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-md-7">
		...
		<small class="text-secondary">Pilih file baru jika ingin mengganti. File saat ini: **<?php echo $download->gambar ?>**</small>
	</div>
	<div class="col-md-2">
		<?php if(!empty($download->gambar)) { ?>
			<a href="<?php echo base_url('assets/upload/file/'.$download->gambar) ?>" target="_blank" class="btn btn-sm btn-outline-info">
...
<div class="form-group row">
	...
	<div class="col-md-5">
		<select name="id_kategori_download" class="form-control">
			...
			<option value="<?php echo $kategori_download->id_kategori_download ?>" 
				<?php echo set_select('id_kategori_download', $kategori_download->id_kategori_download, ($download->id_kategori_download==$kategori_download->id_kategori_download)); ?>>
	...
	<div class="col-md-2">
		<select name="jenis_download" class="form-control">
			<option value="Download" <?php echo set_select('jenis_download', 'Download', ($download->jenis_download=="Download")); ?>>Download</option>
			<option value="Panduan" <?php echo set_select('jenis_download', 'Panduan', ($download->jenis_download=="Panduan")); ?>>Panduan</option>
			<option value="Member" <?php echo set_select('jenis_download', 'Member', ($download->jenis_download=="Member")); ?>>Member</option>
		</select>
		<small class="text-secondary">Jenis konten</small>
	</div>
	<div class="col-md-2">
		<select name="status_download" class="form-control">
			<option value="Publish" <?php echo set_select('status_download', 'Publish', ($download->status_download=="Publish")); ?>>Publish</option>
			<option value="Draft" <?php echo set_select('status_download', 'Draft', ($download->status_download=="Draft")); ?>>Draft</option>
		</select>
...
<div class="form-group row">
	...
	<div class="col-md-9">
		...
		<textarea name="isi" class="form-control konten" placeholder="Deskripsi singkat file download"><?php echo set_value('isi', $download->isi) ?></textarea>
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-md-9">
		<input type="text" name="website" class="form-control" value="<?php echo set_value('website', $download->website) ?>" placeholder="Misal: http://link-eksternal.com">
