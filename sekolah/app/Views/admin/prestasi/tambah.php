...
<div class="form-group row">
	...
	<div class="col-md-2">
		<select name="jenjang_prestasi" class="form-control">
			...
			foreach ($jenjang_options as $jenjang) {
				echo '<option value="'.$jenjang.'" ' . set_select('jenjang_prestasi', $jenjang) . '>' . $jenjang . '</option>';
			}
			?>
		</select>
	...
	<div class="col-md-2">
		<input type="text" name="tanggal_prestasi" class="form-control tanggal" value="<?php if(isset($_POST['tanggal_prestasi'])) { echo set_value('tanggal_prestasi'); }else{ echo date('d-m-Y'); } ?>" placeholder="dd-mm-yyyy">
...
<div class="form-group row">
	...
	<div class="col-md-4">
		<select name="id_kategori_prestasi" class="form-control select2">
			...
			<option value="<?php echo $kategori_prestasi->id_kategori_prestasi ?>" <?php echo set_select('id_kategori_prestasi', $kategori_prestasi->id_kategori_prestasi); ?>>
	...
	<div class="col-md-2">
		<select name="status_prestasi" class="form-control">
			<option value="Publish" <?php echo set_select('status_prestasi', 'Publish'); ?>>Publish</option>
			<option value="Draft" <?php echo set_select('status_prestasi', 'Draft'); ?>>Draft</option>
		</select>
...
<div class="form-group row">
	...
	<div class="col-md-6">
		...
		<small class="text-secondary">Pilih gambar untuk tampilan prestasi.</small>
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-md-9">
		...
		<textarea name="isi" class="form-control konten" placeholder="Deskripsi lengkap prestasi"><?php echo set_value('isi') ?></textarea>
	</div>
</div>
