...
<div class="form-group row">
	...
	<div class="col-md-9">
		...
		<small class="text-secondary">Pilih file gambar untuk galeri/banner.</small>
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-md-3">
		<select name="id_kategori_galeri" class="form-control">
			<?php 
			// Menggunakan set_select untuk kategori
			foreach($kategori_galeri as $kategori_galeri) { ?>
			<option value="<?php echo $kategori_galeri->id_kategori_galeri ?>" <?php echo set_select('id_kategori_galeri', $kategori_galeri->id_kategori_galeri); ?>>
	...
	<div class="col-md-3">
		<select name="jenis_galeri" class="form-control">
			<?php 
			// Menggunakan set_select untuk jenis galeri
			$jenis_options = ['Galeri', 'Homepage', 'Header', 'Pop Up'];
			foreach ($jenis_options as $jenis) {
				echo '<option value="' . $jenis . '" ' . set_select('jenis_galeri', $jenis) . '>' . $jenis . '</option>';
			}
			?>
		</select>
...
<div class="form-group row">
	...
	<div class="col-md-9">
		...
		<textarea name="isi" class="form-control konten" placeholder="Teks lengkap atau deskripsi untuk galeri/slider"><?php echo set_value('isi') ?></textarea>
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-md-9">
		<input type="text" name="text_website" class="form-control" value="<?php echo set_value('text_website') ?>" placeholder="Contoh: Selengkapnya">
...
<div class="form-group row">
	...
	<div class="col-md-9">
		<input type="text" name="website" class="form-control" value="<?php echo set_value('website') ?>" placeholder="Contoh: <?php echo base_url('berita') ?>">
