...
(1, 'SMA NEGERI 1 PHPMU PADANG', '10301989', '4232322', 'JL. Robby Prihandaya, S.Kom, M.Kom', 26175, '0751-190285', 'Linggar Jati', 'Padang Barat', 'Padang', 'Sumatera Barat', 'https://phpmu.com', 'saya@robbyprihandaya.com');
...
(110, '1', '::1', 'Chrome 85.0.4183.121', 'Windows 10', 'superuser', '14:18:13', '2020-10-03');
...
--
ALTER TABLE `rb_users_aktivitas`
  MODIFY `id_users_aktivitas` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=111;
COMMIT;
